...
console.log("1. Cкільки податків ви заплатите як IT-спеціаліст в якійсь з країн",  ((myTex.getMyTaxes.call(ukraine, salary)* 100) /100).toFixed(2) + " " + "грн." + "," + " в Латвіі - ", ((myTex.getMyTaxes.call(latvia, salary)* 100) /100).toFixed(2) + " " + "грн." + "," + " в Літві - ", ((myTex.getMyTaxes.call(litva, salary)* 100) /100).toFixed(2) + " " + "грн.") 
...
let middleTex = {
    getMiddleTex: function (country, salary){
        return this.tax * this.middleSalary;
    }
}

console.log("2. Cкільки у середньому податків платять IT-спеціалісти в Україні - ",  ((middleTex.getMiddleTex.call(ukraine)* 100) /100).toFixed(2) + " " + "грн." + "," + " в Латвіі - ", ((middleTex.getMiddleTex.call(latvia)* 100) /100).toFixed(2) + " " + "грн." + "," + " в Літві - ", ((middleTex.getMiddleTex.call(litva)* 100) /100).toFixed(2) + " " + "грн.") 
